...
from parking.views import home, map_view, parking_list, parking_available, revenue_view, areas_view, parking_detail, activity_log_view
...
urlpatterns = [
    ...
    path('available/', parking_available, name='parking_available'),
